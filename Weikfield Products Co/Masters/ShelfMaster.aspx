<%@ Page Title="Shelf Master" Language="C#" MasterPageFile="~/MasterPages/MasterPage_RN.master" AutoEventWireup="true" CodeFile="ShelfMaster.aspx.cs" Inherits="Masters_ShelfMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SearchContent" Runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function UpdateEquipFunction() {
            ...
            var value = document.getElementById('<%=txtShelfNo.ClientID%>').value;
                            ...
                            <table width="100%" cellspacing="6">
                               ...
                               <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="ddlAisle" runat="server" CssClass="ComboBox" Width="370px" AutoPostBack="true"
                                            TabIndex="1" OnSelectedIndexChanged="ddlAisle_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                                ...
                                <%-- <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="ddlRowNo" runat="server" CssClass="ComboBox" Width="370px" AutoPostBack="true"
                                            TabIndex="3" OnSelectedIndexChanged="ddlRowNo_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                                        <asp:RequiredFieldValidator ID="ReqddlRowNo" runat="server" ControlToValidate="ddlRowNo" AutoPostBack="true"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="ddlCabinet" runat="server" CssClass="ComboBox" Width="370px" AutoPostBack="true"
                                            TabIndex="4">
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                                        ...
                                        <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender4" runat="server"
                                            Enabled="True" TargetControlID="ReqddlCabinet" WarningIconImageUrl="~/Images/Icon/Warning.png">
                                        </ajax:ValidatorCalloutExtender>
                                    </td>
                                </tr>--%>
                              ...
                              <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtShelfNo" runat="server" CssClass="TextBox" Height="18px" MaxLength="200"
                                            Width="368px" TabIndex="1"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:RequiredFieldValidator ID="ReqShelfNo" runat="server" ControlToValidate="txtShelfNo"
                                            Display="None" ErrorMessage="Shelf No Is Required" SetFocusOnError="True"
                                             ValidationGroup="Add">
                                        </asp:RequiredFieldValidator>
                                        <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender2" runat="server" Enabled="True"
                                            TargetControlID="ReqShelfNo" WarningIconImageUrl="~/Images/Icon/Warning.png">
                                        </ajax:ValidatorCalloutExtender>
                                    </td>
                                </tr>
                                <tr>
