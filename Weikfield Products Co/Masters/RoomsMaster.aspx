<%@ Page Title="Rooms Master" Language="C#" MasterPageFile="~/MasterPages/MasterPage_RN.master" AutoEventWireup="true" CodeFile="RoomsMaster.aspx.cs" Inherits="Masters_RoomsMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SearchContent" Runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function UpdateEquipFunction() {
            ...
            var value = document.getElementById('<%=txtRoom.ClientID%>').value;
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div style="text-align:right; margin-right:10px;">Search for Room :
                                    ...
                                    <table width="100%" cellspacing="6">
                                        ...
                                        <tr>
                                            ...
                                            <td style="height: 24px">
                                                <asp:TextBox ID="txtRoom" runat="server" CssClass="TextBox" MaxLength="200" Width="250px" TabIndex="1"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="Req1" runat="server" ControlToValidate="txtRoom"
                                                    Display="None" ErrorMessage="Enter Room Text" SetFocusOnError="True" ValidationGroup="Add">
                    ...
                    <ItemTemplate>
                        <li id="Menuitem" runat="server">
                            <asp:LinkButton ID="lbtn_List" CssClass="linkButton" CausesValidation="false" CommandName="Select"
                                CommandArgument='<%# Eval("#") %>' runat="server" Text='<%# Eval("Room") %>' TabIndex="6"></asp:LinkButton>
