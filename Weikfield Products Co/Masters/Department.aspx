<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage_RN.master" AutoEventWireup="true" CodeFile="Department.aspx.cs" Inherits="Masters_Department" Title="Depatrment Master" %>
  ...
  <input type="hidden" id="hiddenbox" runat="server" value="" />
    ...
    <script type="text/javascript" language="javascript">
        ...
        function UpdateEquipFunction() {
            ...
            var value = document.getElementById('<%=txtDepartment.ClientID%>').value;
                                    ...
                                    <table width="100%" cellspacing="6">
                                        ...
                                        <tr>
                                            ...
                                            <td style="height: 24px">
                                                <asp:TextBox ID="txtDepartment" runat="server" CssClass="TextBox" MaxLength="200" Width="250px" TabIndex="1"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="Req1" runat="server" ControlToValidate="txtDepartment"
                                                    Display="None" ErrorMessage="Enter Department Text" SetFocusOnError="True" ValidationGroup="Add">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Button ID="BtnUpdate" runat="server" Text="Update" CssClass="button" ValidationGroup="Add"
                                                        ...
                                                        TabIndex="2" OnClick="BtnUpdate_Click" OnClientClick="UpdateEquipFunction();"/>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:Button ID="BtnDelete" runat="server" Text="Delete" CssClass="button" ValidationGroup="Add"
                                                        ...
                                                        TabIndex="3" OnClick="BtnDelete_Click"/>
                                                </td>
                                                <td>
                                                    <asp:Button ID="BtnCancel" runat="server" Text="Cancel" CssClass="button" CausesValidation="False"
                                                        TabIndex="4" OnClick="BtnCancel_Click" OnClientClick="DeleteEquipFunction();"/>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <ItemTemplate>
                        <li id="Menuitem" runat="server">
                            <asp:LinkButton ID="lbtn_List" CssClass="linkButton" CausesValidation="false" CommandName="Select"
                                CommandArgument='<%# Eval("#") %>' runat="server" Text='<%# Eval("DepartmentCategory") %>' TabIndex="6"></asp:LinkButton>
